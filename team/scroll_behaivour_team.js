$(document).ready(function () {
    ...
    const containerH1 = $('.container h1');
    ...
    if (screenWidth < 850) {
        ...
        $('body').on('scroll', function (e) {
            ...
            if (scrollDirection === 'down' && infoBehindNavBar >35) {
                containerH1.css('top', -infoBehindNavBar * 0.17 + 'vh');
            ...
            if (infoBehindNavBar > 97) {
                navBar.add(containerH1).add(button).add(Competiton).add(sponsors).add(join).add(projects).add(contact).add(home).add(list).removeAttr('style');
